...
Процедура ПриДобавленииПодсистемы(Описание) Экспорт
	...
	Описание.Имя    = "УправлениеПаркомАттракционов";   // Метаданные.Имя
	Описание.Версия = "1.0.1.12";   						// Метаданные.Версия
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Процедура           = "ОбновлениеИнформационнойБазыПАРеализация.ПренестиПользователейИзПредыдушейВерсии";
	Обработчик.НачальноеЗаполнение = Истина;

	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "1.0.1.4";
	Обработчик.Процедура           = "Справочники.Аттракционы.ПеренестиФотоВПрисоедненныеФайлы";
	Обработчик.РежимВыполнения 	   = "Отложенно";
	Обработчик.Идентификатор       = "9369e947-3167-4432-a150-fbed47e2f35b";
	Обработчик.Комментарий         = НСтр("ru = 'Перенос файлов из хранилища в присоединенные файлы'");
	...
	Обработчик.РежимВыполнения     = "Отложенно";
	Обработчик.Идентификатор       = "b7d07b97-3f69-4897-8449-4fe42dd08eee";	
